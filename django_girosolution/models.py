...
class GirosolutionTransaction(models.Model):
    ...
    latest_response_code = models.IntegerField(_('rc field from girosolution response'), null=True)
    latest_response_msg = models.TextField(_('msg field from girosolution response'), blank=True, null=True)
